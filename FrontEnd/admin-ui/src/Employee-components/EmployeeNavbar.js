    ...
    <nav className="bg-gray-800 p-4">
      <div className="container mx-auto">
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} mt-4`}>
          ...
          <Link to="/employee-dashboard" className="block text-white hover:bg-gray-600 px-3 py-2 rounded-md text-sm font-medium">HomePage</Link>
          <Link to="/my-courses" className="block text-white hover:bg-gray-600 px-3 py-2 rounded-md text-sm font-medium">Courses</Link>
          <Link to="/progress" className="block text-white hover:bg-gray-600 px-3 py-2 rounded-md text-sm font-medium">Employee Progress</Link>
          </div>
        </div>
      </div>
    </nav>
